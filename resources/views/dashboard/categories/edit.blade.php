    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.categories.update', $category->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="filter_class" class="form-label">Kelas Filter*</label>
                    <input type="text" class="form-control @error('filter_class') is-invalid @enderror" id="filter_class" name="filter_class" value="{{ old('filter_class', $category->filter_class) }}" required placeholder="E.g., web-design">
